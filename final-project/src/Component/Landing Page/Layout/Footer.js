        ...
        <footer className="bg-white dark:bg-gray-800 w-full py-4">
            <div className="max-w-screen-xl mx-auto px-12">
                {/* <div className="pt-8 flex max-w-xs mx-auto items-center justify-between">
                    <a
                    target="_blank"
                    href="https://github.com/justinus789" 
                ...
                <div className="text-center text-gray-500 text-xl dark:text-gray-200 py-5 sm:py-6 font-light flex items-center justify-center">
                Created by Justinus Andreas
                </div>
            </div>
        </footer>
    )
