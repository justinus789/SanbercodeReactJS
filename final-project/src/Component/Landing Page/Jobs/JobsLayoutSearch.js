...
const JobsLayoutSearch = () => {
    const {jobSearch,filter,setFilter,clearFilter,search,setSearch,searchStatus,setSearchStatus,functions} = useContext(AppContext)
    const {searchJobsData,filterJobsData,fetchJobsData} = functions
...
export default JobsLayoutSearch